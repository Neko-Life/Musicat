...
void set_cached_user_auth (const std::string &user_id, const nlohmann::json &data);
void remove_cached_user_auth (const std::string &user_id);

nlohmann::json get_cached_user_guilds (const std::string &user_id);

void set_cached_user_guilds (const std::string &user_id, const nlohmann::json &data);
