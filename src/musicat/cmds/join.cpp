...
namespace musicat {
	...
	namespace join {
		...
		switch (res) {
		    case 0: event.reply("Joining..."); return;
		    case 1: event.reply("Join a voice channel first you dummy"); return;
		    case 2: event.reply("I'm already in a voice channel"); return;
		    case 3: event.reply("`[ERROR]` No channel to join"); return;
		    case 4: event.reply("I have no permission to join your voice channel"); return;
		}
	    }
	}
